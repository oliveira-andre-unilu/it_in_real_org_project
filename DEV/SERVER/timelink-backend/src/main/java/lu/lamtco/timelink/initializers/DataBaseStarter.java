...
public class DataBaseStarter implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Project project1 = new Project("Belval University", "MNO1.040", customer1, "49.504575;5.949298");
        projectRepository.save(project1);
        Project project2 = new Project("Luxembourg Gare", "G25-12", customer2, "49.600764;6.134055");
        projectRepository.save(project2);
        Project project3 = new Project("Paris", "NND-1162", customer1, "48.853369;2.349000");
        Project project4 = new Project("New York", "ESB-911", customer1, "40.711572;-74.013276");
        Project project5 = new Project("Tokyo", "WW2-45", customer1, "35.659630;139.700661");
        Project project6 = new Project("Lisbon", "EQ-1755", customer2, "38.708002;-9.136651");
        Project project7 = new Project("Stockholm", "ES-ARC", customer2, "59.332296;18.072005");
